    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http.csrf(csrf -> csrf.csrfTokenRepository(org.springframework.security.web.csrf.CookieCsrfTokenRepository.withHttpOnlyFalse())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers( "/productos/**", "/subastas/**").hasAnyRole("ADMIN", "CLIENTE")
                        .requestMatchers( "/", "/index", "/login", "/registrar").permitAll()
                        .requestMatchers( "/css/**", "/js/**", "/images/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/usuarios/registrar").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/productos/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/productos/**").hasAnyRole("ADMIN", "CLIENTE")
                        .requestMatchers(HttpMethod.PUT, "/api/productos/**").hasAnyRole("ADMIN", "CLIENTE")
